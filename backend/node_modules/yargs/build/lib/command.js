...
export class CommandInstance {
    ...
    addHandler(cmd, detalhes, builder, handler, commandMiddleware, deprecated) {
        let aliases = [];
        ...
        if (Array.isArray(cmd)) {
            ...
            this.addHandler([cmd].concat(aliases), detalhes, builder.builder, builder.handler, builder.middlewares, builder.deprecated);
            return;
        }
        if (typeof cmd === 'string') {
            ...
            if (detalhes !== false) {
                this.usage.command(cmd, detalhes, isDefault, aliases, deprecated);
            }
    ...
    parseAndUpdateUsage(isDefaultCommand, commandHandler, innerYargs, parentCommands, commandIndex, helpOnly) {
        ...
        if (this.shouldUpdateUsage(innerYargs)) {
            innerYargs
                .getInternalMethods()
                .getUsageInstance()
                .usage(this.usageFromParentCommandsCommandHandler(parentCommands, commandHandler), commandHandler.detalhes);
        }
    ...
    runDefaultBuilderOn(yargs) {
        ...
        if (this.shouldUpdateUsage(yargs)) {
            ...
            yargs
                .getInternalMethods()
                .getUsageInstance()
                .usage(commandString, this.defaultCommand.detalhes);
        }
    ...
    extractDesc({ describe, detalhes, desc }) {
        for (const test of [describe, detalhes, desc]) {
