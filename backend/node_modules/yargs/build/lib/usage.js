...
export function usage(yargs, shim) {
    ...
    let examples = [];
    self.example = (cmd, detalhes) => {
        examples.push([cmd, detalhes || '']);
    };
    let commands = [];
    self.command = function command(cmd, detalhes, isDefault, aliases, deprecated = false) {
        if (isDefault) {
        ...
        commands.push([cmd, detalhes || '', isDefault, aliases, deprecated]);
    };
