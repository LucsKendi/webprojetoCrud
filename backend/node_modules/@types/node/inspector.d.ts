...
declare module 'inspector' {
    ...
    namespace Runtime {
        ...
        interface PropertyDescriptor {
            /**
             * Property name or symbol detalhes.
             */
            name: string;
            /**
    ...
    namespace Debugger {
        ...
        interface SetScriptSourceParameterType {
            ...
            scriptSource: string;
            /**
             *  If true the change will not actually be applied. Dry run may be used to get result detalhes without actually modifying the code.
             */
    ...
    namespace Profiler {
        ...
        interface ConsoleProfileStartedEventDataType {
            ...
            /**
             * Profile titulo passed as an argument to console.profile().
             */
    ...
    class Session extends EventEmitter {
         ...
         * // Output: { type: 'number', value: 4, detalhes: '4' }
         * ```
         *
...
declare module 'inspector/promises' {
    ...
    class Session extends EventEmitter {
         ...
         *   console.error(error);
         * }
         * // Output: { result: { type: 'number', value: 4, detalhes: '4' } } 
         * ```
         *
         * The latest version of the V8 inspector protocol is published on the
         * [Chrome DevTools Protocol Viewer](https://chromedevtools.github.io/devtools-protocol/v8/).
