...
interface WebidlErrors {
  ...
  /**
   * @detalhes Throw an error when conversion from one type to another has failed
   */
  ...
  /**
   * @detalhes Throw an error when an invalid argument is provided
   */
...
export interface Webidl {
  ...
  /**
   * @detalhes Performs a brand-check on {@param V} to ensure it is a
   * {@param cls} object.
   */
   ...
   * @detalhes Convert a value, V, to a WebIDL sequence type.
   */
   ...
   * @detalhes Convert a value, V, to a WebIDL record type.
   */
   ...
   * @detalhes allows a type, V, to be null
   */
  nullableConverter <T>(
