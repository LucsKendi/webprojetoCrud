...
class EntityMetadataValidator {
    ...
    validate(entityMetadata, allEntityMetadatas, driver) {
        ...
        entityMetadata.relations.forEach((relation) => {
            ...
            // todo: add validation if there two entities with the same target, and show error message with detalhes of the problem (maybe file was renamed/moved but left in output directory)
