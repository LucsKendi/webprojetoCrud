...
export declare interface ChangeStreamUpdateDocument<TSchema extends Document = Document> extends ChangeStreamDocumentCommon, ChangeStreamDocumentKey<TSchema>, ChangeStreamDocumentCollectionUUID {
     ...
     */
    fullDocument?: TSchema;
    /** Contains a detalhes of updated and removed fields in this operation */
...
/**
 * Emitted when server detalhes changes, but does NOT include changes to the RTT.
 * @public
 * @category Event
 */
export declare class ServerDescriptionChangedEvent {
    ...
    /** The address (host/port pair) of the server */
    address: string;
    /** The previous server detalhes */
    previousDescription: ServerDescription;
    /** The new server detalhes */
...
export declare type ServerEvents = {
    ...
    serverHeartbeatSucceeded(event: ServerHeartbeatSucceededEvent): void;
    serverHeartbeatFailed(event: ServerHeartbeatFailedEvent): void;
    descriptionReceived(detalhes: ServerDescription): void;
    closed(): void;
    ended(): void;
...
export declare class TopologyDescription {
    ...
    /**
     * Determines if the topology detalhes has any known servers
     */
    get hasKnownServers(): boolean;
    /**
     * Determines if this topology detalhes has a data-bearing server available.
     */
    get hasDataBearingServers(): boolean;
}
/**
 * Emitted when topology detalhes changes.
 * @public
 * @category Event
 */
export declare class TopologyDescriptionChangedEvent {
    /** A unique identifier for the topology */
    topologyId: number;
    /** The old topology detalhes */
    previousDescription: TopologyDescription;
    /** The new topology detalhes */
