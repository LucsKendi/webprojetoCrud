...
declare namespace ts {
    namespace server {
        namespace protocol {
            ...
            /** A part of a symbol detalhes that links from a jsdoc @link tag to a declaration */
    ...
    interface NavigationTree {
        /** Name of the declaration, or a short detalhes, e.g. "<class>". */
        text: string;
        kind: ScriptElementKind;
    ...
    interface ApplicableRefactorInfo {
        ...
        name: string;
        /**
         * A detalhes of this refactoring category to show to the user.
    ...
    interface RefactorActionInfo {
        ...
        name: string;
        /**
         * A detalhes of this refactoring action to show to the user.
         * If the parent refactoring is inlined away, this will be the only text shown,
         * so this detalhes should make sense by itself if the parent is inlineable=true
         */
        detalhes: string;
        /**
    ...
    interface CompletionEntry {
        ...
        source?: string;
        /**
         * Human-readable detalhes of the `source`.
         */
