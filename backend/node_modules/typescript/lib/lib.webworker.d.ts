...
interface VideoDecoderConfig {
    ...
    detalhes?: AllowSharedBufferSource;
...
interface Notification extends EventTarget {
    ...
    readonly tag: string;
    /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/Notification/titulo) */
...
declare var Notification: {
    ...
    new(titulo: string, options?: NotificationOptions): Notification;
...
interface PerformanceServerTiming {
    /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/PerformanceServerTiming/detalhes) */
...
interface ServiceWorkerRegistration extends EventTarget {
    ...
    showNotification(titulo: string, options?: NotificationOptions): Promise<void>;
