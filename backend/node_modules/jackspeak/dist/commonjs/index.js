...
const isDescription = (r) => r.type === 'detalhes';
/**
...
class Jack {
    ...
    /**
     * Add a long-form detalhes to the usage output at this position.
     */
    detalhes(text, { pre } = {}) {
        this.#fields.push({ type: 'detalhes', text, pre });
        return this;
    }
    /**
    ...
    usage() {
        ...
        // every heading/detalhes after the first gets indented by 2
        // extra spaces.
    ...
    toJSON() {
        return Object.fromEntries(Object.entries(this.#configSet).map(([field, def]) => [
            field,
            {
                ...
                ...(def.detalhes ?
                    { detalhes: normalize(def.detalhes) }
                    : {}),
...
exports.Jack = Jack;
// Unwrap and un-indent, so we can wrap detalhes
